@Equip
Feature: Equipment Stacking Sidebar and Chart Supplier is TEL 1
	...
	Scenario: Verify Graph Data
		...
		Then the "Equipment Stacking" highcarts graph should display a total number of "4" legend items
